...
Покрытие функционального кода составляет **95.10%** (более 75%).

| Файл | Строк | Покрыто | Процент |
|------|-------|---------|---------|
| src/product.py | 40 | 40 | 100% |
| src/category.py | 31 | 31 | 100% |
| src/__init__.py | 5 | 5 | 100% |
| src/base_product.py | 16 | 12 | 75% |
| src/mixin.py | 10 | 9 | 90% |
| **Итого** | **102** | **97** | **95.10%** |

Отчёт доступен в папке [`htmlcov/`](htmlcov/index.html).
